...
public class RelaxationExerciseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mExerciseImageView = findViewById(R.id.exerciseImageView);
        mTextTextView = findViewById(R.id.textTextView);
        ...
        mRatingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                if(fromUser){
                    if(mRating != null){
                        mRating.setRelaxationExerciseRating(rating);
    ...
    public static Intent intentFactory(Context context, int userId){
        Intent intent = new Intent(context, RelaxationExerciseActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
